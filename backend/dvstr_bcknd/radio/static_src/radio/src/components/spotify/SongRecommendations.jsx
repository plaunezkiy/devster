...
const TrackItem = ({ track }) => {
  ...
  return (
    <div className="h-fit p-2.5 relative flex items-center space-x-3 hover:bg-gray-100 dark:hover:bg-zinc-600">
      <button
        // onClick={() => (playing ? audio.pause() : audio.play())}
        className="relative h-full hover:bg-green-500 group focus:outline-none group/button divide-x"
      >
        {loading ? (
    ...
    <div className="w-full divide-y divide-black">
      <div className="flex px-2 justify-between bg-gray-100 dark:bg-zinc-600">
        ...
        <div className="buttons flex gap-2 items-center">
          <button
            className="font-semibold py-1 px-2 border border-blue-500 rounded text-white hover:bg-blue-500 duration-150"
