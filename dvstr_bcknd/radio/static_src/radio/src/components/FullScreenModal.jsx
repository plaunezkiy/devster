...
const FullScreenModal = ({ open, setOpen, trackInfo }) => {
  ...
  return (
    ...
    >
      <img src={currentTrack?.album?.images[0].url} className="absolute top-0 left-0 w-full h-full scale-110 blur-lg -z-10" alt="" />
      ...
      <div className="w-3/5 h-1/3 flex gap-8 items-end">
        <img
